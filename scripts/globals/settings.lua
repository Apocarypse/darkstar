...
NORMAL_MOB_MAX_LEVEL_RANGE_MIN = 80; -- Lower Bound of Max Level Range for Normal Mobs (0 = Uncapped)
NORMAL_MOB_MAX_LEVEL_RANGE_MAX = 80; -- Upper Bound of Max Level Range for Normal Mobs (0 = Uncapped)
...
COFFER_MAX_ILLUSION_TIME = 600;  -- 1 hour
COFFER_MIN_ILLUSION_TIME = 300;  -- 30 minutes
CHEST_MAX_ILLUSION_TIME  = 600;  -- 1 hour
CHEST_MIN_ILLUSION_TIME  = 300;  -- 30 minutes
...
-- DYNAMIS SETTINGS
   ...
   PRISMATIC_HOURGLASS_COST = 1;    -- cost of the prismatic hourglass for Dynamis.
     CURRENCY_EXCHANGE_RATE = 30;      -- X Tier 1 ancient currency -> 1 Tier 2, and so on.  Certain values may conflict with shop items.  Not designed to exceed 198.
...
RIVERNE_PORTERS = 600; -- Time in seconds that Unstable Displacements in Cape Riverne stay open after trading a scale.
LANTERNS_STAY_LIT = 9000; -- time in seconds that lanterns in the Den of Rancor stay lit.
...
DIG_ABUNDANCE_BONUS = 990; -- Increase chance of digging up an item (450  = item digup chance +45)
